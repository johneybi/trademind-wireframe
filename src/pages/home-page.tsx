...
const stackItems = [
  ...
  "Motion for React wired with sample animations",
];
          ...
          >
            ...
            <div className="space-y-4">
              ...
              <p className="max-w-2xl text-lg leading-8 text-muted-foreground">
                ...
                and move only repeated pieces into <code className="rounded bg-muted px-1.5 py-0.5 text-sm">src/components</code>.
              </p>
            </div>
